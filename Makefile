...
reconstruct_sketch:
	python edit3d/reconstruct_from_sketch.py config/chair_demo.yaml --pretrained=data/models/airplanes_epoch_2799_iters_156800.pth --outdir output/recon_sketch --impath examples/recon_sketch/chairs/ce10e4e0d04c33e7322ed2ef5fc90e25/sketch-F-2.png --mask  --mask-level 0.5

reconstruct_rgb:
	python edit3d/edit3d/reconstruct_from_rgb.py config/airplane_demo.yaml --pretrained=data/models/airplanes_epoch_2799_iters_156800.pth --outdir output/recon_rgb --impath examples/recon_sketch/airplanes/d54ca25127a15d2b937ae00fead8910d/sketch-T-2.png --mask  --mask-level 0.5
